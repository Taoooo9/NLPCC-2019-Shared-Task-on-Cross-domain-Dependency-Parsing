...
if __name__ == '__main__':
    ...
    argparser.add_argument('--labelled_file', nargs='+', help = '<Required> Set config List', required = True)
    ...
    labelled_target = read_corpus(args.labelled_file, vocab)
